...
(1, 3, 1, 'Call Latter Send', 'Invited on 21-july-2023.'),
(2, 3, 2, 'Call Latter Send', 'You are Invited For Interview on 10-july-2023.'),
(3, 3, 3, 'Call Latter Send', 'Invited on 21-Aug-2023.'),
(4, 3, 4, 'Call Latter Send', 'Invited on 21-Aug-2023.');
...
(1, 'TCS Private Limited', 'Mr. Mohan Shah', 'Navarangpura1', 'Ahmedabad', 'mohan@gmail.com', 9898989898, 'Software', 'Confirm', 'janobe', 'janobe', 'Who is Your Favourite Person?', 'sachin'),
(2, 'Wipro Infotech', 'Mr. Sunil Pandya', 'Baroda', 'Baroda', 'sunil@wipro.com', 8989898989, 'Hardware', 'Confirm', 'sunil', 'sunil', '', ''),
(3, 'Solusoft  Pvt Limite', 'Mr. Nirav Soni', 'Narayanpura', 'Ahmedabad', 'nirav@gmail.com', 9898989898, 'Software', 'Confirm', 'nirav', 'nirav', 'What is Your Pet Name?', 'niru'),
(4, 'Info Matrics', 'Mr. Narayan', 'Sahibagh', 'Ahmedabad', 'narayan@yahoo.com', 6767676767, 'Software', 'Confirm', 'narayan', 'narayan', 'What is Your Pet Name?', 'nari');
...
(1, 3, 'asdad', '2023-05-13'),
(2, 3, 'asd', '2023-05-18'),
(3, 4, 'Thanks For Your Support.', '2023-05-18'),
(4, 3, 'asd', '2023-05-22');
...
(1, 'Jalpa Prajapati', 'Near Dena Bank', 'Mehsana', 'jalpa@gmail.com', 9898989898, 'M.C.A', 'Female', '2020-09-10', 'Marksheet.pdf', 'Confirm', 'jalpa', 'jalpa', 'What is Your Pet Name?', 'jalpa'),
(2, 'Krunal Prajapati', 'Patan', 'Patan', 'krunal@gmail.com', 8989898989, 'M.B.A', 'Male', '2020-09-16', 'Marksheet.pdf', 'Confirm', 'krunal', 'krunal', '', ''),
(3, 'Gopal Patel', 'Patan', 'Patan', 'gopal@gmail.com', 9898989898, 'MA', 'Male', '2020-10-15', 'admin.jpg', 'Confirm', 'gopal', 'gopal', '', ''),
(4, 'Mehul Mistry', 'Swastik SOciety', 'Baroda', 'mehul@gmail.com', 8989898998, 'BE', 'Male', '2020-10-09', '470X310_1.jpg', 'Confirm', 'mehul', 'mehul', 'What is Your Pet Name?', 'mehu');
...
(1, 'Register and Get JOB', '2023-04-24'),
(2, 'New Vacancies will be updated after diwali', '2023-05-31'),
(3, 'test', '2023-06-19');
...
(1, 'Wipro Infotech', 'Freshers Required', 5, 'B.C.A', 'Hardworking Person are Required.', '2023-07-25', '09:00:00'),
(2, 'TCS Private Limited', 'Marketive Representative Invited', 2, 'Pharmacist', 'Ready TO work in North Gujarat', '2023-08-07', '09:00:00');
